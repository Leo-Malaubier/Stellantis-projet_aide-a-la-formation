...
class settings:
    ...
    def numbers_to_strings(self,argument):
        ...
        #j'aurais voulus utilisé un switch, mais le switch parcour toutes les option et exectute toutes les self donc la meilleur option est une suite de if
        if valeur1 =="collones" :
        ...
        if valeur1 == "parametreImage" :
            self.setparametreImage(valeur2)
        if valeur1 == "parametreVideo" :
            self.setparametreVideo(valeur2)
    ...
    def setparametreImage(self,valeur):
        self._parametreImage=valeur
        self._logger.info(self._indice)

    def setparametreVideo(self,valeur):
        self._parametreVideo=valeur
        self._logger.info(self._indice)
