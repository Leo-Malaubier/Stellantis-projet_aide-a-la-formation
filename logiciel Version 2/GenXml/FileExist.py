...
def verification():
    ...
    if not os.path.exists(emplacement_fichier+'image'):
        os.makedirs(emplacement_fichier+'image')
    if not os.path.exists(emplacement_fichier+'video'):
        os.makedirs(emplacement_fichier+'video')
    return 'Done'
